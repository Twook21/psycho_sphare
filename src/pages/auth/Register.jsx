...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-indigo-50 dark:from-gray-900 dark:to-indigo-950 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center transition-colors duration-200">
      <Helmet>
        <title>Register - Psycho-Sphare</title>
        <meta name="description" content="Daftar akun baru di Psycho-Sphare untuk mengakses test kepribadian, minat, dan bakat." />
        <meta name="keywords" content="register, daftar, akun baru, mbti, kepribadian, psikotes, minat, bakat" />
      </Helmet>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="relative md:w-1/2 h-60 md:h-auto bg-indigo-600 dark:bg-indigo-800">
              <div 
                ...
                style={{ 
                  backgroundImage: "url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80')",
                  opacity: 0.7
                }}
              ></div>
              ...
              <div className="relative flex flex-col justify-center px-8 py-12 h-full text-white z-10">
                <h2 className="text-3xl font-bold mb-4">Mulai Perjalanan Penemuan Diri</h2>
                <p className="text-lg text-indigo-100">Daftar sekarang untuk mengakses berbagai test psikometrik yang akan membantu Anda memahami diri sendiri lebih baik.</p>
