  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setRegisterError(result.error || 'Gagal mendaftar. Silakan coba lagi.');
      }
    } catch (error) {
  ...
  return (
    <div className="w-full">
      <div className="mb-6 text-center">
        <h2 className="text-3xl font-bold mb-2 text-gray-800 dark:text-gray-100">Buat Akun Baru</h2>
        <p className="text-gray-600 dark:text-gray-300">Mulai perjalanan penemuan diri Anda dengan mendaftar sekarang</p>
      </div>
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          ...
          <input 
            ...
            className={`w-full px-4 py-2 rounded-lg border ${errors.name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'} focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 transition-colors duration-200`}
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Konfirmasi Password</label>
          <div className="relative">
            <input 
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2 rounded-lg border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'} focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 transition-colors duration-200`}
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Sudah memiliki akun?{' '}
          <Link to="/login" className="font-medium text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">
            Masuk sekarang
          </Link>
        </p>
      </div>
      ...
      <div className="mt-8">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">Atau daftar dengan</span>
          </div>
        </div>
